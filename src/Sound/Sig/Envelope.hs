...
--
-- Нужно везде, где сигнал режется по времени: рендер обрезает жёстко, и без
-- скоса край становится щелчком. Скос зажимается половиной длины, то есть
-- на коротком окне выходит треугольник, а не ошибка.
